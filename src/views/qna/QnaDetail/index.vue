    ...
    <div class="inner-container qna-detail">
      ...
      <section class="detail-form" v-if="details">
        ...
        <template v-if="details.type == 'SICK'">
          ...
          <div class="textarea-item">
            <AutoResizeTextArea class="sub-contents" v-model="details.plantLifeCycle" maxlength="500" readonly />
          </div>
          <div class="input-title">증상이 나타났을 때 어떻게 대처하셨나요?</div>
          <div class="textarea-item">
            <AutoResizeTextArea class="sub-contents" v-model="details.plantCountermeasure" maxlength="500" readonly />
          </div>
        </template>
