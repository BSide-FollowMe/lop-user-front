<template>
  <section class="sunlight">
    ...
    <div class="main__content">
      식물마다 건강하게 자라는데 필요한 햇빛의 양이 있어요. 어떤 식물은 강한 햇빛을 좋아해서, 빛이 부족하면 햇빛을 찾아서 키만 커지기도
      하고요. 또 어떤 식물은 부드러운 빛을 좋아해서, 너무 강한 빛을 비추면 잎이 타버리기도 해요. 그렇기 때문에 내 식물이 원하는 빛의 양을 잘
      알고 적당한 위치에 놓아주는 것이 중요합니다.
    </div>
  ...
  <section class="sub-group">
    ...
    <section class="sub">
      ...
      <div>
        ...
        <div class="sub__content">
          하루에 5시간 이상 빛을 받을 수 있는 곳으로, 유리창을 거친 햇빛이 집 안에서 가장 강하게 내리쬐는 곳이에요. 식물을 베란다 창쪽 또는
          창가에 두시면 좋아요.
          <div class="sub__content__detail">
            <div class="label">조도계 기준</div>
    ...
    <section class="sub">
      ...
      <div>
        ...
        <div class="sub__content">
          햇빛이 직접 닿지는 않지만, 간접적인 빛을 하루에 3시간 정도 받을 수 있는 밝은 곳이에요. 커튼이나 다른 식물을 거쳐 들어오는 햇빛을
          받는 곳이기도 해요. 식물을 거실 창 쪽이나 안쪽에 두시면 좋아요.
          <div class="sub__content__detail">
            <div class="label">조도계 기준</div>
    ...
    <section class="sub">
      ...
      <div>
        ...
        <div class="sub__content">
          ...
          <div class="sub__content__detail">
            <div class="label">조도계 기준</div>
            <div class="value">300 ~ 2,000 Lux</div>
          </div>
        </div>
      </div>
    </section>
...
export default defineComponent({
  setup() {
    setMeta({
      title: '햇빛 가이드 - 식물의언어',
      description:
        '식물마다 건강하게 자라는데 필요한 햇빛의 양이 있어요. 어떤 식물은 강한 햇빛을 좋아해서, 빛이 부족하면 햇빛을 찾아서 키만 커지기도 하고요. 또 어떤 식물은 부드러운 빛을 좋아해서, 너무 강한 빛을 비추면 잎이 타버리기도 해요. 그렇기 때문에 내 식물이 원하는 빛의 양을 잘 알고 적당한 위치에 놓아주는 것이 중요합니다.',
      keywords: `가이드, 햇빛`,
      path: '/guide/sunlight',
    });
  },
...
.sub-group {
  ...
  .sub {
    ...
    .icon {
      ...
      border-radius: 25px;
      &.direct-sunlight {
        background-image: url('@/assets/images/guide/direct-sunlight.svg');
        background-repeat: no-repeat;
        background-position: center center;
      }
      &.sunny-spot {
        background-image: url('@/assets/images/guide/sunny-spot.svg');
        background-repeat: no-repeat;
        background-position: center center;
      }
      &.semi-sunny-spot {
        background-image: url('@/assets/images/guide/semi-sunny-spot.svg');
        background-repeat: no-repeat;
        background-position: center center;
      }
      &.semi-shady-spot {
        background-image: url('@/assets/images/guide/semi-shady-spot.svg');
        background-repeat: no-repeat;
        background-position: center center;
      }
      &.shady-spot {
        background-image: url('@/assets/images/guide/shady-spot.svg');
        background-repeat: no-repeat;
        background-position: center center;
      }
    }
